...
public class TheBagExample {
    public static void main(String[] args) {
        ...
        ArrayBag<Position3D> cloneArrayBag = myBag.cloneMethod();
        System.out.println("cloned bag size is " + cloneArrayBag.size());
        ArrayBag<Position3D> cloneArrayBag1 = copiedBag.cloneMethod();
        System.out.println("cloned bag size is " + cloneArrayBag1.size());
        ArrayBag<Position3D> cloneArrayBag2 = unionBag.cloneMethod();
        System.out.println("cloned bag size is " + cloneArrayBag2.size());
    }
}
class ArrayBag<E> {
    private Object[ ] data;
    ...
    public ArrayBag<E> cloneMethod(){
        return new ArrayBag<>(this);
    };
